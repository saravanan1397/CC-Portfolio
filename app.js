          ...
          <article class="ppr-detail-card">
            <div class="ppr-detail-card-head">
              <div>
                ...
                <div class="ppr-detail-meta">${escapeHtml(group.purchasedFrom || partnerName)}${group.latestDate ? ` | ${escapeHtml(formatDateTime(group.latestDate))}` : ""}</div>
              </div>
                ...
                <div class="ppr-detail-item">
                  <div>
                    ...
                    <div class="ppr-detail-meta">
                      ${escapeHtml(formatRpSourceName(item.cardId))}${item.createdAt ? ` | ${escapeHtml(formatDateTime(item.createdAt))}` : ""}
                    </div>
                    <div class="ppr-detail-meta">
